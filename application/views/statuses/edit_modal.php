<div class="modal-dialog">
    ...
    <div class="modal-content">
		...
		<div class="modal-body">
			...
			<?php echo form_open("statuses/edit/" . $status['status_id'], $attributes);?>
		...
		<div class="modal-footer">
			<a href="/status/delete/<?php echo $status['status_id']; ?>" id="delete" class="btn btn-danger pull-left"><i class="glyphicon glyphicon-fire icon-white"></i> Delete</a>
